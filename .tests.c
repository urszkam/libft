...
void test_ft_memcmp()
{
    ...
    int result = same_sign(result1, expected1);
    ...
    result = same_sign(result2, expected2);
    printf("Test 2: ft_memcmp(\"Tested\", \"Test\", 4) - Result: %d, Expected: %d - %s\n",
        result2, expected2, result ? GREEN "PASS" COLOR_RESET : RED "FAIL" COLOR_RESET);
    ...
    result = same_sign(result3, expected3);
    ...
    result = same_sign(result5, expected5);
...
void test_ft_putstr_fd()
{
    ...
    (void)read(fd1, result1, strlen(str1));
...
void test_ft_putendl_fd()
{
    ...
    (void)read(fd2, result2, strlen(str2)+1);
    result = strcmp(result2, expected2) == 0;
...
void test_ft_putnbr_fd()
{
    ...
    (void)read(fd2, result2, strlen(str2));
