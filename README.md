...
## Functions
### Libc Functions
Replicas of functions from the libc with names prefixed by 'ft_'
...
22. **ft_calloc:** Initializes newly created array (with memory allocation) to zero.
23. **ft_strdup:** Duplicates a string with memory allocation.
...
- [Linux man pages](https://linux.die.net/man/3/) - reference for standard C functions.
- Linux manual - local documentation.
- [Stack Overflow](https://stackoverflow.com) - additional explanations and examples functions implementation.
- [Makefile Tutorial](https://makefiletutorial.com/) - practical Makefile guide.
- [Makefile Documentation](https://ocw.mit.edu/courses/1-124j-foundations-of-software-engineering-fall-2000/pages/lecture-notes/gnu_makefile_documentation/) - documentation for Makefile usage.
